...
function css() {
	return src(path.src.css, {})
		...
		// .pipe(dest(path.build.css)) // uncomment if need file.min.css
		// .pipe(clean_css())
		// .pipe(
		// 	rename({
		// 		extname: ".min.css"
...
let build = gulp.series(clean, fonts_otf, gulp.parallel(html, css, js, favicon, others, copyScss, copyTpl, images), fonts, gulp.parallel(fontstyle));
